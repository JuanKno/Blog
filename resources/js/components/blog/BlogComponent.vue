            ...
            <div class="card-columns listrecent">
                ...
                <div class="card">
                    <a href="post">
                        <img
                            class="img-fluid"
                            src="assets/blog/img/demopic/5.jpg"
                            alt=""
                        />
                    </a>
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >Autumn doesn't have to be nostalgic, you
                                know?</a
                            >
                        </h2>
                        <h4 class="card-text">
                ...
                <div class="card">
                    <a href="post">
                        <img
                            class="img-fluid"
                            src="assets/blog/img/demopic/6.jpg"
                            alt=""
                        />
                    </a>
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >Best galleries in the world with photos</a
                            >
                        </h2>
                        <h4 class="card-text">
                            This is a longer card with supporting text below as
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >Little red dress and a perfect summer</a
                            >
                        </h2>
                        <h4 class="card-text">
                            This is a longer card with supporting text below as
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >Thinking outside the box can help you
                                prosper</a
                            >
                        </h2>
                        <h4 class="card-text">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >10 Things you should know about choosing your
                                house</a
                            >
                        </h2>
                        <h4 class="card-text">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h2 class="card-title">
                            <a href="post"
                                >Visiting the world means learning cultures</a
                            >
                        </h2>
                        <h4 class="card-text">
                            This is a longer card with supporting text below as
